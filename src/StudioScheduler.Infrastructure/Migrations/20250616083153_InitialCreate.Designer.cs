...
namespace StudioScheduler.Infrastructure.Migrations
{
    ...
    [Migration("20250616083153_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StudioScheduler.Core.Models.Reservation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("StudioScheduler.Core.Models.Reservation", b =>
                {
                    ...
                    b.HasOne("StudioScheduler.Core.Models.Schedule", null)
                        .WithMany("Reservations")
                        .HasForeignKey("ScheduleId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                    ...
                    b.HasOne("StudioScheduler.Core.Models.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
